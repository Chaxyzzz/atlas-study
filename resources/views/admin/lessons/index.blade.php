...
<head>
    ...
    <title>Lessons - ATLAS Study</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <main class="main-content">
        <div class="header">
            <h1>Lessons</h1>
            <a href="{{ route('admin.lessons.create') }}" class="btn-primary">+ Add Lesson</a>
        </div>
                    ...
                    <tbody>
                        @foreach($lessons as $lesson)
                            <tr>
                                <td>
                                    {{ $lesson->title }}
                                    <div style="color: #888888; font-size: 12px; margin-top: 4px;">{{ $lesson->slug }}</div>
                                </td>
                                <td>
                                    @if($lesson->category)
                                ...
                                <td>{{ $lesson->user ? $lesson->user->name : '-' }}</td>
                                <td>
                                ...
                                <td>
                                    <div class="actions">
                                        <a href="{{ route('admin.lessons.edit', $lesson) }}" class="btn-action">Edit</a>
